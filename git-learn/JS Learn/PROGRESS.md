...
| Metric | Value |
|---|---|
| Token-track lessons | 117 |
| Founder-track lessons (F1, counted separately) | 16 |
| Legacy lessons (pre-pivot, excluded) | 0 |
| Quiz questions (track) | 3173 |
| Avg teaching prose per track lesson | 2103 words |
| Lessons with a playground | 117 / 117 |
| Lessons with an exercise | 117 / 117 |
| **Deepened** (all 3 spine sections) | 16 / 117 |
| **Verified** (code executed) | 117 / 117 |
| Ran clean but had nothing to run | 0 / 117 |
| Errors | 0 |
| Known and blocked | 0 |
| Warnings | 2 |
...
1798 keyed questions (multiple-choice, spot-the-bug, which-breaks).
...
> across all 1798 questions, versus the authored figures below. Index 3 sits
...
| c7-observability | 2 | 1037 | 8 | 2 | 52 | 0/2 | 2/2 |
...
| search-index.json | 134 entries, 0 dead, 0 unindexed |
