...
| Metric | Value |
|---|---|
| Token-track lessons | 105 |
| Founder-track lessons (F1, counted separately) | 16 |
| Legacy lessons (pre-pivot, excluded) | 0 |
| Quiz questions (track) | 2861 |
| Avg teaching prose per track lesson | 2211 words |
| Lessons with a playground | 105 / 105 |
| Lessons with an exercise | 105 / 105 |
| **Deepened** (all 3 spine sections) | 16 / 105 |
| **Verified** (code executed) | 105 / 105 |
| Ran clean but had nothing to run | 0 / 105 |
| Errors | 0 |
| Known and blocked | 0 |
| Warnings | 2 |
...
1547 keyed questions (multiple-choice, spot-the-bug, which-breaks).
...
> across all 1547 questions, versus the authored figures below. Index 3 sits
...
| c1-testing-quality | 2 | 1273 | 10 | 3 | 53 | 0/2 | 2/2 |
...
| search-index.json | 122 entries, 0 dead, 0 unindexed |
