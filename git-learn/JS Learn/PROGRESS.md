...
| Metric | Value |
|---|---|
| Token-track lessons | 122 |
| Founder-track lessons (F1, counted separately) | 16 |
| Legacy lessons (pre-pivot, excluded) | 0 |
| Quiz questions (track) | 3303 |
| Avg teaching prose per track lesson | 2065 words |
| Lessons with a playground | 122 / 122 |
| Lessons with an exercise | 122 / 122 |
| **Deepened** (all 3 spine sections) | 16 / 122 |
| **Verified** (code executed) | 122 / 122 |
| Ran clean but had nothing to run | 0 / 122 |
| Errors | 0 |
| Known and blocked | 0 |
| Warnings | 2 |
...
1897 keyed questions (multiple-choice, spot-the-bug, which-breaks).
...
> across all 1897 questions, versus the authored figures below. Index 3 sits
...
| c6-scale-performance | 3 | 1318 | 24 | 3 | 78 | 0/3 | 3/3 |
...
| search-index.json | 139 entries, 0 dead, 0 unindexed |
