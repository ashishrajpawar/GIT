...
| Metric | Value |
|---|---|
| Token-track lessons | 114 |
| Founder-track lessons (F1, counted separately) | 16 |
| Legacy lessons (pre-pivot, excluded) | 0 |
| Quiz questions (track) | 3095 |
| Avg teaching prose per track lesson | 2130 words |
| Lessons with a playground | 114 / 114 |
| Lessons with an exercise | 114 / 114 |
| **Deepened** (all 3 spine sections) | 16 / 114 |
| **Verified** (code executed) | 114 / 114 |
| Ran clean but had nothing to run | 0 / 114 |
| Errors | 0 |
| Known and blocked | 0 |
| Warnings | 2 |
...
1731 keyed questions (multiple-choice, spot-the-bug, which-breaks).
...
> across all 1731 questions, versus the authored figures below. Index 3 sits
...
| c3-trust-safety | 2 | 1115 | 8 | 2 | 52 | 0/2 | 2/2 |
...
| search-index.json | 131 entries, 0 dead, 0 unindexed |
